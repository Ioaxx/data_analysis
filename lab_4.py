...
for file_index, file_path in enumerate(file_paths):
    ...
    subsample_positive = 0
    subsample_negative = 0
    subsample_count = 0  # Count for the subsample
    ...
    try:
        with open(file_path, "r") as infile:
            ...
            while True:
                ...
                # Update totals for subsample
                subsample_positive += positive_count
                subsample_negative += negative_count
                subsample_count += 1

                # Check if we have reached the subsample size
                if event_counter % subsample_size == 0:
                    total_positive += subsample_positive
                    total_negative += subsample_negative
                    subsample_positive = 0
                    subsample_negative = 0
    ...
    # Add remaining subsample counts
    total_positive += subsample_positive
    total_negative += subsample_negative
